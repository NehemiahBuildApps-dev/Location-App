...
import com.project.locationapp.ui.theme.LocationAppTheme
...
@Composable
fun MyApplication(viewModel: LocationViewModel){
        ...
        onResult = { permissions ->
            if (permissions[Manifest.permission.ACCESS_COARSE_LOCATION] == true
                ...
                if (rationalRequired){
                    ...
                    Toast.makeText(context,
                        "Location permission is required. Enable in android settings",
                        Toast.LENGTH_LONG).show()
                }
            }
        })
